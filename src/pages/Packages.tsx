                  ...
                  <div className="p-6 lg:p-8">
                    ...
                    {!user ? (
                      <motion.button
                        ...
                        className={`w-full py-4 rounded-full font-medium flex items-center justify-center gap-2 transition-all duration-300 group ${
                      ...
                      <motion.button
                        whileHover={{ scale: 1.02 }}
                        whileTap={{ scale: 0.98 }}
                        onClick={() => handleBooking(pkg.id, pkg.title)}
                        className={`w-full py-4 rounded-full font-medium flex items-center justify-center gap-2 transition-all duration-300 group ${
                          pkg.popular ? "btn-primary" : "btn-secondary"
                        }`}
                      >
