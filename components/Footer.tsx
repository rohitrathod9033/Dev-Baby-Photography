          ...
          >
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+919427765032" className="text-card/70 hover:text-primary transition-colors">
                  +91 9427765032
                </a>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="w-5 h-5 text-primary flex-shrink-0" />
                <a href="mailto:rohitrathod60371@gmail.com" className="text-card/70 hover:text-primary transition-colors">
