    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-muted-foreground">Upload an image or provide a direct link.</p>
          {isUploading && <p className="text-xs text-primary animate-pulse">Uploading image...</p>}
        </div>

        {/* Color Theme */}
        <div className="space-y-2">
          <label className="block text-sm font-medium text-foreground">Color Theme (Tailwind Class)</label>
          <Input
            type="text"
            placeholder="e.g., from-rose-100 to-rose-200"
